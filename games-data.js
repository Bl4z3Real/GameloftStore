...
const APPS = [
  ...
  {
    name: "N.O.V.A. 2: Near Orbit Vanguard Alliance",
    dev: "Gameloft",
    ...
    version: "1.0.5",
    genre: "Sparatutto",
    desc: "The Best Sci-Fi FPS Game Is Back! Immerse Yourself in a Whole New Dimension of Gaming!  The best sci-fi FPS game is back! Immerse yourself in a whole new dimension of gaming!  Pocket Gamer — 9/10 + Gold Award: “It surpasses its predecessor with faster-paced action, fantastic graphics, and the best multiplayer yet.”  IGN — 8.5/10 + Editor's Choice: “Smooth controls are a great help during the intense action.”  The AppEra: “N.O.V.A. 2 is without a doubt the best FPS game.”  TouchGen: “Its intense gameplay is absolutely impossible to put down.”  148apps: “N.O.V.A. 2 is a game that rivals console titles.”  App Advice: “It provides the ultimate online multiplayer experience, with fast connections and battles for up to 10 players.”  The Ultimate Game, Faster and More Powerful Than Ever! Encounter new enemies equipped with improved artificial intelligence, master countless different weapons and powers, and enjoy ever-changing gameplay: running, shooting, falling, riding a motorbike, controlling a giant mech, firing lasers, and much more. Up to 10 players can play together across 10 multiplayer maps.  Six years have passed since the first story. Humanity has been thrown into a bloody civil war between the Earth Orbit Government and a mysterious new organization known as the Human-Alien Alliance. Our protagonist, Kal Wardin, left the N.O.V.A. forces of Earth Orbit years ago and had been living with farmers in a local colony on the planet Scorpius. But even this most peaceful of places could not escape the flames of a merciless war...  An Unparalleled Single-Player Campaign: 12 chapters featuring countless enemies and spectacular environments across a variety of locations, dozens of weapons, and 3 special powers: Freeze, Time Delay, and the melee attack Disc.  Intense Multiplayer Modes: online or local play for 1–10 players, 5 modes (Free-for-All, Team Deathmatch, Capture the Flag, Capture the Point, and One-Shot Kill), ranking and perk systems, and 10 maps featuring thrilling battles.",
    screenshots: [
      "https://web.archive.org/web/20120210072114im_/https://lh5.ggpht.com/JYJbkZ_Nm9jPnP_3-z-ye1j2D49wQov3AMCPVzJwFbyKd2pvBFdDDHd9mEWOLFVyn-SH=h230",
      "https://web.archive.org/web/20120210072115im_/https://lh5.ggpht.com/bFa23zFOQjOV03fizpZtpImLBu6mA4wlgnVJZlgCGwDIlRKTfz8RTobKlfBPetYUrA=h230",
      "https://web.archive.org/web/20120210072121im_/https://lh4.ggpht.com/A4EXi1JPQajqJE56u4WMeprtJOGrCyViXfddyLGPNfgnTKh02gV_Mn9lywCZzZlLpd7o=h230",
      "https://web.archive.org/web/20120210072114im_/https://lh3.ggpht.com/b_DRC0gmwAIwWIQ2ieJAwjhSiQmsg-hTlATmZ7pF6ySCHTbRYdz1CRmA0yrEb4o-NKpL=h230",
      "https://web.archive.org/web/20120210072115im_/https://lh6.ggpht.com/Lo8AbLHSr-V3H8vWmStTmQ7Has2JUr-rmzVqpsduOOlkiEPaXNKhuCMWKuxyMFg8WHn-=h230",
      "https://web.archive.org/web/20120210072116im_/https://lh6.ggpht.com/20ecKN1WdzFbemNpohXT56lgeGGbAYkzCkUNi-A5L_9nQMeiYGCXCXpnhrUM5O9lom_a=h230"
    ],
    link: "https://archive.org/download/nova-2-hd-v-1-0-5/NOVA-2-HD-v1-0-5.apk",
    trailer: "msadQkD5xYU"
  },
  {
    name: "N.O.V.A. 3: Near Orbit Vanguard Alliance",
    dev: "Gameloft",
    icon: "https://web.archive.org/web/20120602073452im_/https://lh4.ggpht.com/fQ1KBWR3buj5xt5DaMFRAAL2AsWUrnZW-YErTVSMOgqlKm45ydkYjI6cY0mZhMLuS8g=w124",
    color: "#c0392b",
    rating: 5,
    price: "€6.99",
    category: "games",
    ...
    version: "1.0.8e",
    genre: "Sparatutto",
    desc: "The most immersive and impressive sci-fi FPS franchise on smartphones is back! Fight for mankind's survival in the greatest space shooter on mobile devices! ** Note that N.O.V.A. 3 needs 2GB of free memory to install **  Four months have passed since Kal ruined the Volterites' plans by sabotaging their war factories, and stopping the extraction of the Judger Artifacts. However, following the assassination of President Folsom, the government surrendered the colonies to the Volterite Protectorate in order to prevent civil war. Kal Wardin has been laying low since Folsom's death, but now he has received a desperate plea from Yelena to come to Earth. Once again, the hero must rise to save mankind!  • An epic storyline: Humanity finally returns to Earth after years of exile! Fight in 10 immersive levels across the galaxy, from a war-torn Earth to a frozen Volterite city. • Multiple weapons and powers: Run, shoot, drive vehicles, and pilot a mech to defeat hordes of enemies. • Join 12-player battles in 6 multiplayer modes (Capture the Point, Free-for-All, Capture the Flag, etc.) on 6 different maps. • For the first time, multiple allies can jump inside the same vehicle and spread destruction on the battlefield. • Discover the new FPS benchmark for graphics and gameplay (real-time shadow & lights, particle system, ragdoll physics, etc.)  For fans of the N.O.V.A. series, first-person shooters and action games on Android.",
    screenshots: [
      "https://web.archive.org/web/20120602073451im_/https://lh5.ggpht.com/D3yMNNEOfl7Gz8qCqCJjCNsflk7O2SBrhfYw9__wAuNri7XD7VPws3pHAtvUeogeLg=h230",
      "https://web.archive.org/web/20120602073451im_/https://lh3.ggpht.com/te5avVn1PBRumWP2pafl4nQs_akqn8X9P0G_7HQfJSGEMhhl0WDjExeGDnNvpKM81s4=h230",
      "https://web.archive.org/web/20130108132944im_/https://lh5.ggpht.com/t4O5-3gGKrqWypHmE4ahcLbHkbbLasEa1Wp6fh1GLm0EhosOi4jgre1TlfPlSNbZ4kw=h230",
      "https://web.archive.org/web/20130108132949im_/https://lh6.ggpht.com/6K7Ls0r2w84YUBnVY71qJ5yVMdeq_CGdriqb6UxbM4Xcfz1f3OO7O4bcp0lq2p2WRImc=h230"
    ],
    link: "https://dl11s.apkawards.com/MoD11/dl11/com.gameloft.android.GAND.GloftN3LT/com.gameloft.android.GAND.GloftN3LT_1.0.8e-APK_Award.apk",
    trailer: "2CSOIh6lpB8"
  },
  {
